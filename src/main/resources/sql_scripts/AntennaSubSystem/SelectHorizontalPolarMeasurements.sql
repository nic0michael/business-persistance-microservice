-- Select columns for antenna where measurement is HPOLAR and antenna code in (list of antenna codes);
...
WHERE d.antenna_code = a.antenna_code
	  ...
	  AND
	  d.antenna_code IN ('ANT002','ANT004')
	  AND
	  d.measurement_code = 'HPOLAR'
